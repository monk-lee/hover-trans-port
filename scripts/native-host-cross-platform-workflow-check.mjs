...
for (const [expected, description] of [
  ...
  ["hover-trans-port-native-host-macos-0.2.19.tar.gz", "macOS inspect-first package"],
  ["hover-trans-port-native-host-linux-0.2.19.tar.gz", "Linux inspect-first package"],
  ["hover-trans-port-native-host-windows-0.2.19.zip", "Windows inspect-first package"]
]) {
...
for (const [expected, description] of [
  ...
  ["hover-trans-port-native-host-linux-0.2.19.tar.gz", "CI Linux inspect-first package"],
  ["hover-trans-port-native-host-windows-0.2.19.zip", "CI Windows inspect-first package"]
]) {
