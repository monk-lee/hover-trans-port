...
for (const [expected, description] of [
  ...
  ["hover-trans-port-native-host-linux-0.2.17.tar.gz", "Linux inspect-first package"],
  ["hover-trans-port-native-host-windows-0.2.17.zip", "Windows inspect-first package"]
]) {
