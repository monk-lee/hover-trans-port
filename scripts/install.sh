...
Environment overrides:
  ...
  HOVER_TRANS_PORT_ASIDE_NATIVE_HOSTS_DIR
...
if [ "$PLATFORM_OS" = "macos" ]; then
  ...
  ASIDE_NATIVE_HOSTS_DIR="${HOVER_TRANS_PORT_ASIDE_NATIVE_HOSTS_DIR:-$HOME_DIR/Library/Application Support/Aside/NativeMessagingHosts}"
else
...
if [ "$PLATFORM_OS" = "macos" ]; then
  MANIFEST_PATHS+=("$ASIDE_NATIVE_HOSTS_DIR/$HOST_NAME.json")
fi
