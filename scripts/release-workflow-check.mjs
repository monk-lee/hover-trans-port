...
const requiredSnippets = [
  ...
  ["hover-trans-port-native-host-macos-0.2.10.tar.gz", "native host tarball asset"],
  ["Adds translation latency diagnostics to the Debug Log", "latency diagnostics release note"],
  ["Deduplicates identical in-flight translation requests", "inflight dedupe release note"],
  ["Keeps selected-text translations in a fixed bubble", "selection bubble release note"],
