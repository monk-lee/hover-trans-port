...
const requiredSnippets = [
  ...
  ["hover-trans-port-native-host-macos-0.2.13.tar.gz", "native host tarball asset"],
  ["Checks only the selected translation provider", "selected provider status release note"],
  ["Avoids executing Antigravity during provider status checks", "Antigravity status release note"],
  ["Antigravity is only launched for explicit translations", "Antigravity explicit launch release note"],
