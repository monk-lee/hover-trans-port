...
const requiredSnippets = [
  ...
  ["hover-trans-port-native-host-macos-0.2.3.tar.gz", "native host tarball asset"],
  ["Native host update required:", "native host update release note"],
  ["Existing v0.2.2 native hosts do not understand update messages", "manual first update release note"],
  ["Future update-capable native host releases can be installed from Options", "native auto-update next release note"],
