...
const requiredSnippets = [
  ...
  ["hover-trans-port-native-host-macos-0.2.9.tar.gz", "native host tarball asset"],
  ["Shows selected-text translations in a fixed bubble anchored to the selected range", "selection bubble release note"],
  ["Keeps hovered readable block translations inline", "hover-block inline release note"],
  ["Adds bubble dismissal with outside click, Escape, page scroll, and resize", "bubble dismissal release note"],
  ["Guards against stale selection and hover responses replacing newer translation UI", "stale response release note"],
