...
const requiredSnippets = [
  ...
  ["hover-trans-port-native-host-macos-0.2.8.tar.gz", "native host tarball asset"],
  ["Fixes the native helper's internal host/version report", "native helper version hotfix release note"],
  ["Adds Gemini CLI as a selectable translation provider alongside Codex CLI and Claude CLI", "Gemini provider release note"],
  ["Parses Gemini CLI JSON responses and surfaces Gemini authentication/runtime errors", "Gemini error release note"],
  ["Runs Gemini translation requests in an isolated temporary workspace", "Gemini isolation release note"],
