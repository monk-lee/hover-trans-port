...
const requiredSnippets = [
  ...
  ["hover-trans-port-native-host-macos-0.2.4.tar.gz", "native host tarball asset"],
  ["Native host update required:", "native host update release note"],
  ["Existing v0.2.3 native hosts can install this release from Options", "update-capable host release note"],
