...
const requiredSnippets = [
  ...
  ["hover-trans-port-native-host-macos-0.2.11.tar.gz", "native host tarball asset"],
  ["Adds OpenCode CLI as an optional translation provider", "OpenCode provider release note"],
  ["Uses OpenCode's configured default model", "OpenCode default model release note"],
  ["Runs OpenCode with --pure, stdin prompt input, a pinned built-in build agent", "OpenCode hardened invocation release note"],
