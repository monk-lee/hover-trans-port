...
const requiredSnippets = [
  ...
  ["hover-trans-port-native-host-macos-0.2.12.tar.gz", "native host tarball asset"],
  ["Adds Antigravity CLI as an optional translation provider", "Antigravity provider release note"],
  ["Invokes Antigravity through agy --print using the CLI-configured default model", "Antigravity default model release note"],
  ["Documents Antigravity privacy and security boundaries", "Antigravity security release note"],
