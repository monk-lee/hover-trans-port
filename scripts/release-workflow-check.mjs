...
const requiredSnippets = [
  ...
  ["hover-trans-port-native-host-macos-0.2.6.tar.gz", "native host tarball asset"],
  ["Keeps selection translation and whole-sentence translation states separate", "selection sentence cache fix release note"],
