...
- [ ] Release notes mention macOS + Chrome + Codex CLI, Claude CLI, Gemini CLI, and Antigravity CLI support
...
- [ ] Confirm README does not imply official affiliation with OpenAI, Codex, Anthropic, Claude, Google, Gemini, or Antigravity.
- [ ] Confirm privacy docs disclose that Codex CLI, Claude CLI, Gemini CLI, and Antigravity CLI may send requested text upstream according to each CLI provider's account and policies.
